...
unsafe fn axe_hopv_game(weapon: &mut L2CAgentBase) {
    ...
    if is_excute(weapon) {
        ATTACK(weapon, 0, 0, Hash40::new("top"), 13.0, 62, 64, 0, 77, 14.0, 0.0, 0.0, 0.0, Some(0.0),Some(0.0),Some(0.0), 1.5, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, -4, 0.0, 0, false, true, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_fire"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_MAGIC);
