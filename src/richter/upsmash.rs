...
const DAMAGE: f32 = 13.0;
const DAMAGE_LINK: f32 =3.0;
...
unsafe fn richter_attack_hi4_game(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(fighter) {
        ...
        ATTACK(fighter, 0, 0, Hash40::new("throw"), DAMAGE_LINK, 368, kbg, fkb, 0, 3.0, 0.0, 0.0, 0.0, None,None,None, 0.5, 0.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, shield_damage, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);

        ATTACK(fighter, 1, 0, Hash40::new("throw"), DAMAGE_LINK, 368, kbg, fkb, 0, 3.0, 0.0, 0.0, -z, Some(0.0), Some(0.0),Some(-z/2.0), 0.5, 0.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, shield_damage, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        ATTACK(fighter, 2, 0, Hash40::new("throw"), DAMAGE_LINK, 368, kbg, fkb, 0, 3.0, 0.0, 0.0, z, Some(0.0), Some(0.0),Some(z/2.0), 0.5, 0.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, shield_damage, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        ...
        let offset = smash::phx::Vector2f { x: ORIGIN_Z, y: FAMILIAR_LENGTH-10.0};
        AttackModule::set_vec_target_pos(fighter.module_accessor, 0, Hash40::new("rot"), &offset, 3, false);
        AttackModule::set_vec_target_pos(fighter.module_accessor, 1, Hash40::new("rot"), &offset, 3, false);
        AttackModule::set_vec_target_pos(fighter.module_accessor, 2, Hash40::new("rot"), &offset, 3, false);
    ...
    if is_excute(fighter) {
        ...
        ATTACK(fighter, 0, 0, Hash40::new("throw"), DAMAGE_LINK, 90, kbg, fkb/5, 0, 3.5, 0.0, 3.0, 0.0, Some(0.0), Some(FAMILIAR_LENGTH-4.0), Some(0.0), 0.05, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, 8, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
